...
class SiteSettingsResponse(BaseModel):
    ...
    tier_premium_price_usd: int = 0
    tier_premium_plus_price_usd: int = 0
...
class SiteSettingsUpdate(BaseModel):
    ...
    tier_premium_price_usd: int | None = None
    tier_premium_plus_price_usd: int | None = None
    announcement_title: str | None = None
    announcement_content: str | None = None
    announcement_active: bool = False
...
def get_settings(db: Session = Depends(get_db)):
    ...
    return SiteSettingsResponse(
        ...
        tier_premium_price_usd=settings.tier_premium_price_usd or 0,
        tier_premium_plus_price_usd=settings.tier_premium_plus_price_usd or 0,
...
def update_settings(data: SiteSettingsUpdate, db: Session = Depends(get_db)):
    ...
    settings.tier_premium_price_usd = data.tier_premium_price_usd if data.tier_premium_price_usd is not None else settings.tier_premium_price_usd
    settings.tier_premium_plus_price_usd = data.tier_premium_plus_price_usd if data.tier_premium_plus_price_usd is not None else settings.tier_premium_plus_price_usd
